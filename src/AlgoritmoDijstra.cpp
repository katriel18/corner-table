...
//Impresion del camino mas corto desde el vertice inicial y final ingresados
	...
	void dijkstra(int inicial) {
		...
		//TRIANGULO ES IGUAL A VERTICES EN ESTE ALGORITO GENERAL
		cout << "Distancias mas cortas iniciando en el triangulo " << inicial<< " :"<<endl<<endl;
		for (int i = 1; i <= V; ++i) {
			cout << "Hacia el Triangulo " << i << ", la distancia mas corta es "
					<< distancia[i] << "."<<endl;

		}


		cout<<endl << "Ingrese triangulo de destino: " << endl;
		int destino;
		cin >> destino;
		cout << "Impresion de camino mas corto desde el triangulo "
				<<inicial<<" al triangulo "<<destino<<" es:"<< endl;
		print(destino);
		cout << endl;
	}
